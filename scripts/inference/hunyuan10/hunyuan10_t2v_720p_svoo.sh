...
# Example:
#   GPUS=0 bash scripts/inference/hunyuan10/hunyuan10_t2v_720p_svoo.sh
#
# User-facing overrides:
#   MODEL_ROOT=/path/to/models Look for MODEL_ROOT/HunyuanVideo.
...
#   CPU_OFFLOAD=1              Enable model CPU offload.
...
output_dir="${OUTPUT_DIR:-result/hunyuan10/t2v/svoo}"
sparsity_csv="sparsity_profiles/sparsity_hunyuan10_13B_t2v.csv"
