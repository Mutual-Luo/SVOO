...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Generate video with SVOO using Wan-Diffuser")
    ...
    parser.add_argument("--prompt_source", type=str, default="prompt", choices=["prompt"], help="Source of the prompt")
