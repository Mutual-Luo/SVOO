...
class HunyuanVideoTokenReplaceTransformerBlock_Sparse(HunyuanVideoTokenReplaceTransformerBlock):
    """Double Stream Transformer Block with Token Replacement (I2V)"""
    ...
    def forward(
        ...
        **kwargs,
        ...
        # 1. Input normalization (9 return values)
        (
            norm_hidden_states,
            gate_msa,
            shift_mlp,
        ...
        # 2. Joint attention (Pass timestep)
        attn_output, context_attn_output = self.attn(
            hidden_states=norm_hidden_states,
            encoder_hidden_states=norm_encoder_hidden_states,
            attention_mask=attention_mask,
...
class HunyuanVideoTokenReplaceSingleTransformerBlock_Sparse(HunyuanVideoTokenReplaceSingleTransformerBlock):
    """Single Stream Transformer Block with Token Replacement (I2V)"""
    ...
    def forward(
        ...
        **kwargs,
        ...
        # 1. Input normalization (3 return values)
...
def replace_sparse_forward():
    ...
    HunyuanVideoTokenReplaceTransformerBlock.forward = HunyuanVideoTokenReplaceTransformerBlock_Sparse.forward
    HunyuanVideoTokenReplaceSingleTransformerBlock.forward = HunyuanVideoTokenReplaceSingleTransformerBlock_Sparse.forward
